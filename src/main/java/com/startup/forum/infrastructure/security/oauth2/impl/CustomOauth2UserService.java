...
import com.startup.forum.domain.exception.CustomAccessDeniedException;
import com.startup.forum.domain.exception.CustomAuthenticationException;
...
public class CustomOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        if(userRequest == null) {
            log.debug("Getting null instead oauth2 user request in Oauth2UserService!");
            throw new CustomAuthenticationException("Oauth2UserRequest can't be null!");
        }
