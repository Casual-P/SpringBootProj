...
import com.startup.forum.infrastructure.security.CustomAuthenticationFailureHandler;
import com.startup.forum.infrastructure.security.CustomSecurityConfigurer;
import com.startup.forum.infrastructure.security.oauth2.impl.CustomOauth2UserService;
import com.startup.forum.infrastructure.security.oauth2.impl.CustomOauthTokenConverter;
import com.startup.forum.infrastructure.security.oauth2.impl.Oauth2LoginSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .loginPage("/api/auth/login").permitAll()
                .defaultSuccessUrl("/api/view/main", false)
                .failureUrl("/api/auth/login?error").permitAll()
                .and()
                .rememberMe()
